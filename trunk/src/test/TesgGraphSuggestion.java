...
public class TesgGraphSuggestion {
	...
	public static void main(String[] args) {
		...
		operations.get("5").getProducts().add(datas.get("K"));
		...
		operations.get("8").getRequirements().add(datas.get("K"));
		operations.get("8").getProducts().add(datas.get("M"));
		
		operations.get("9").getRequirements().add(datas.get("L"));
		operations.get("9").getRequirements().add(datas.get("M"));
